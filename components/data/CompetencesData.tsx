...
export const frontCompetences: CompetenceType[] = [
  ...
  {
    name: 'Flutter',
    img: '/images/competence/flutterLogo.png',
  },
  {
    name: 'Tailwindcss',
  ...
  {
    name: 'VusJs',
    img: '/images/competence/vueLogo.png',
  },
  {
    name: 'Angular',
    img: '/images/competence/angularLogo.png',
  },
  {
    name: 'Next.js',
  ...
  {
    name: 'QT/C++',
    img: '/images/competence/qtLogo.png',
  },
];
...
export const backCompetences: CompetenceType[] = [
  ...
  {
    name: 'Laravel',
    img: '/images/competence/laravelLogo.png',
  },
  {
    name: 'Postgres',
  ...
  {
    name: 'Spring Boot',
    img: '/images/competence/springLogo.png',
  },
];
...
export const toolsCompetences: CompetenceType[] = [
  ...
  {
    name: 'Jira',
    img: '/images/competence/jiraLogo.png',
  },
  {
    name: 'Power Bi',
    img: '/images/competence/powerbiLogo.png',
  },
  {
    name: 'TensorFlow',
    img: '/images/competence/tensorflowLogo.png',
  },
